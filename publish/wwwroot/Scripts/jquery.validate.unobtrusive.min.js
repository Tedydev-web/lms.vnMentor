...
!(function (a) {
					...
					options: {
						...
						errorPlacement: function () {
							!function (a, e) {
								...
								e.removeClass("field-validation-valid").addClass("field-validation-error"), a.data("unobtrusiveContainer", e), n ? (e.empty(), a.removeClass("input-validation-error").appendTo(e)) : a.hide();
							}.apply(n, arguments),
						...
						success: function () {
							!function (a) {
								var e,
									n = a.data("unobtrusiveContainer");
								n && ((e = (e = n.attr("data-valmsg-replace")) ? s.parseJSON(e) : null), n.addClass("field-validation-valid").removeClass("field-validation-error"), a.removeData("unobtrusiveContainer"), e && n.empty());
							}.apply(n, arguments),
								a("success", arguments);
						},
					},
	...
	return (
				...
				d &&
					...
					s.each(this.adapters, function () {
						...
						void 0 !== e &&
							...
							this.adapt({ element: t, form: d, message: e, params: n, rules: i, messages: r }));
					}),
					s.extend(i, { __dummy__: !0 }),
		...
		o.methods.extension ? (a.addSingleVal("accept", "mimtype"), a.addSingleVal("extension", "extension")) : a.addSingleVal("extension", "extension", "accept"),
		...
		a.add("remote", ["url", "type", "additionalfields"], function (t) {
			var i = { url: t.params.url, type: t.params.type || "GET", data: {} },
				r = n(t.element.name);
		...
		a.add("password", ["min", "nonalphamin", "regex"], function (a) {
			a.params.min && l(a, "minlength", a.params.min), a.params.nonalphamin && l(a, "nonalphamin", a.params.nonalphamin), a.params.regex && l(a, "regex", a.params.regex);
		}),
